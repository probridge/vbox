...
public class NavbarPageConfigImpl implements NavbarPageConfig {
	...
	public NavbarPageConfigImpl() {
		...
		pageMap.put("fn2", new NavbarPage("fn2", "vBox管理", "/imgs/doc.png", "vm_mgmt.zul"));
		pageMap.put("fn3", new NavbarPage("fn3", "用户", "/imgs/fn.png", "user_mgmt.zul"));
		pageMap.put("fn4", new NavbarPage("fn4", "课程", "/imgs/fn.png", "course_mgmt.zul"));
		pageMap.put("fn5", new NavbarPage("fn5", "审核中心", "/imgs/fn.png", "approval_mgmt.zul"));
		pageMap.put("fn6", new NavbarPage("fn6", "母盘管理", "/imgs/fn.png", "golden_master_mgmt.zul"));
		pageMap.put("fn7", new NavbarPage("fn7", "系统设置", "/imgs/fn.png", "configuration.zul"));
//		pageMap.put("fn8", new NavbarPage("fn8", "管理控制", "/imgs/fn.png", "sysop.zul"));
