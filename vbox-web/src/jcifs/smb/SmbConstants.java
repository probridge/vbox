...
interface SmbConstants {
	...
	// PATCH: static final int DEFAULT_RCV_BUF_SIZE = 60416;
	// PATCH: static final int DEFAULT_SND_BUF_SIZE = 16644;
	...
	static final int DEFAULT_FLAGS2 = FLAGS2_LONG_FILENAMES | FLAGS2_EXTENDED_ATTRIBUTES
			| (USE_EXTSEC ? FLAGS2_EXTENDED_SECURITY_NEGOTIATION : 0) | (SIGNPREF ? FLAGS2_SECURITY_SIGNATURES : 0)
			| (USE_NTSTATUS ? FLAGS2_STATUS32 : 0) | (USE_UNICODE ? FLAGS2_UNICODE : 0);
	static final int DEFAULT_CAPABILITIES = (USE_NTSMBS ? CAP_NT_SMBS : 0) | (USE_NTSTATUS ? CAP_STATUS32 : 0)
			| (USE_UNICODE ? CAP_UNICODE : 0) | CAP_DFS;
	...
	static final int RESPONSE_TIMEOUT = Config.getInt("jcifs.smb.client.responseTimeout", DEFAULT_RESPONSE_TIMEOUT);
	...
	static final int CONN_TIMEOUT = Config.getInt("jcifs.smb.client.connTimeout", DEFAULT_CONN_TIMEOUT);
