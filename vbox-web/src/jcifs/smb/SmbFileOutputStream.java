...
public class SmbFileOutputStream extends OutputStream {
	...
	// PATCH: private int openFlags, access, writeSize;
	...
	public SmbFileOutputStream(SmbFile file, boolean append) throws SmbException, MalformedURLException,
			UnknownHostException {
		this(file, append, append ? SmbFile.O_CREAT | SmbFile.O_WRONLY | SmbFile.O_APPEND : SmbFile.O_CREAT
				| SmbFile.O_WRONLY | SmbFile.O_TRUNC);
	}
	...
	SmbFileOutputStream(SmbFile file, boolean append, int openFlags) throws SmbException, MalformedURLException,
			UnknownHostException {
		this.file = file;
		this.append = append;
	...
	public void writeDirect(byte[] b, int off, int len, int flags) throws IOException {
		...
		int w;
		do {
			// PATCH: w = len > writeSize ? writeSize : len;
