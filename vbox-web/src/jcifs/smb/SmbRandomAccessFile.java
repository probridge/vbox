...
public class SmbRandomAccessFile implements DataOutput, DataInput {
	...
	public SmbRandomAccessFile(SmbFile file, String mode) throws SmbException, MalformedURLException,
			UnknownHostException {
		this.file = file;
		if (mode.equals("r")) {
		...
		// PATCH: readSize = file.tree.session.transport.rcv_buf_size - 70;
		// PATCH: writeSize = file.tree.session.transport.snd_buf_size - 70;
