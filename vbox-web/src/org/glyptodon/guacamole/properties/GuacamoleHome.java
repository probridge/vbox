...
public class GuacamoleHome {
	...
	/**
	 * Returns the Guacamole home directory by checking, in order: the
	...
	public static File getDirectory() {
		...
		// vBox: get properties file from webapp WEB-INF directory
		guacHome = new File(VBoxConfig.configPath);
