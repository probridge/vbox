			...
			<div class="container">
				...
				<div class="navbar-collapse collapse navbar-responsive-collapse">
					<ul class="nav navbar-nav">
						<li><a href="home.do">Workspace</a></li>
						<li><a href="tutorial.do">How to use</a></li>
						...
						<ul class="nav navbar-nav navbar-right">
							<li class="dropdown"><a href="#" class="dropdown-toggle"
								...
								<ul class="dropdown-menu">
									<li><a href="logout.do"><i class="icon-unlock"></i>&nbsp;Logout</a></li>
								</ul></li>
						</ul>
					</shiro:authenticated>
					<shiro:notAuthenticated>
						<ul class="nav navbar-nav navbar-right">
							<li class="dropdown"><a href="#" class="dropdown-toggle"
								...
								<ul class="dropdown-menu">
									<li><a href="jaccount.do"><i class="icon-lock"></i>&nbsp;jAccount Sign-in</a></li>
									<li><a href="login.do?other=1"><i class="icon-lock"></i>&nbsp;Other User</a></li>
								</ul></li>
						</ul>
					</shiro:notAuthenticated>
				</div>
